...
app = Flask(__name__)
CORS(app)
print("--> Starting Text2Image Server. This might take up to two minutes.")

from dalle_model import DalleModel
dalle_model = None

parser = argparse.ArgumentParser(description = "An ML-Powered Text2Image app to turn your textual prompts into visionary delights")
...
with app.app_context():
    ...
    print("--> Text2Image Server is up and running!")
    print(f"--> Model selected - Text2Image {args.model_version}")
